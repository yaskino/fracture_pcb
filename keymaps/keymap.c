...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL,          KC_LALT,          KC_SPC,  KC_LWIN,          KC_SPC,           KC_RALT,          MO(_SECONDARY),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_SECONDARY] = LAYOUT(
    ...
    _______, _______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,          RGB_VAI, RGB_VAD, RGB_MOD, RGB_RMOD, _______, _______,          _______, KC_VOLD, 
    _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,          
